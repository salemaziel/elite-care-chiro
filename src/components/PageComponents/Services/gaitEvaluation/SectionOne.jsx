            ...
            <div className={gaitStyles.sidebarWidget}>
              <ul className={gaitStyles.Categories}>
                ...
                <li className={gaitStyles.active}>
                  <Link to="/services/gait-evaluation" id="gait">Gait Evaluation</Link>
                </li>
                <li>
          ...
          <div className={gaitStyles.ServicesSingle}>
            <div className={gaitStyles.InnerBox}>
              ...
              <div className={gaitStyles.InnerText}>
                <p>
                  Gait analysis is the study of locomotion, for our purposes in
                  humans to measure the movement of the body in space
                  (kinematics) and the forces involved in producing these
                  movements (Kinetics). In the patients carrying injuries due to
                  the involvement in running, walking, and occasionally cycling,
                  a gait evaluation can help in finding how the injury happened
                  and evaluating the plan of its treatment.
                </p>
                <p>
                  We provide extensive extremely comprehensive gait evaluations
                  involving how a patient may stand, walk, and run or ride.
                  Furthermore, the study of shoes is a big factor involved in
                  our tests including the need for foot insoles to correct the
                  biomechanics of a patient’s body. Particularly for cyclists, a
                  custom insole has proved to be a valuable solution as it
                  provides a greater contact surface for your foot with the
                  pedal.{" "}
                </p>
                {/*Two Column*/}
              </div>
