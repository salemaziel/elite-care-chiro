...
const SectionOne = () => (
<div className={treatmentStyles.sidebarPageContainer}>
  <div className={treatmentStyles.autoContainer}>
    <Row>
      {/*Sidebar Side*/}
      <div className="sidebar-side col-lg-3 col-md-4 col-sm-12 col-xs-12">
        <aside className={treatmentStyles.AsideCategories}>
          {/*Blog Category Widget*/}
          <div className={treatmentStyles.sidebarWidget}>
            <ul className={treatmentStyles.Categories}>
            ...
            <li><Link to="/services/gait-evaluation">Gait Evaluation</Link></li>
              ...
              <li className={treatmentStyles.active}><Link to="/treatments/motor-vehicle-collisions">Motor Vehicle Collisions</Link></li>
        ...
        {/*  <div className="sidebar-widget brochure-widget">
          ...
          {/*Info Widget*/}
          <div className={treatmentStyles.ListWidget}>
            <ul>
      ...
      <div className="col-lg-9 col-md-8 col-sm-12 col-xs-12">
        <div className={treatmentStyles.ServicesSingle}>
          <div className={treatmentStyles.InnerBox}>
            ...
            {/*  <p>Podcasting operational change management inside of workflows to establish a framework. Taking seamless key performance indicators offline to maximise the long tail. Keeping your eye on the ball while performing a deep dive on the start-up mentality to derive convergence on cross-platform integration.</p>
              ...
              <div className={treatmentStyles.ColumnTwo}>
                <Col>
                  ...
                  <ul className={treatmentStyles.ServicesTherapyList}>
              ...
              <div className="row clearfix">
                ...
                <div className="column col-lg-4 col-md-12 col-sm-12 col-xs-12">
                  <div className="visit-box">
                    <div className={treatmentStyles.InnerBox}>
                      <h2>Visit Today</h2>
                      <div className={treatmentStyles.InnerText}>You'll know the minute you arrive this is the place. We are here to surpass your desires.</div>
